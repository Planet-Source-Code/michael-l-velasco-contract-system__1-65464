...
Begin VB.Form Cartv2 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Kiosk/carts/Common Areas"
   ClientHeight    =   6495
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   9555
   Icon            =   "CartM3&M2.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6495
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      ForeColor       =   8388608
      TabCaption(0)   =   "Tenant "
      TabPicture(0)   =   "CartM3&M2.frx":4F0A
      ...
      TabCaption(1)   =   "Other "
      TabPicture(1)   =   "CartM3&M2.frx":4F26
   ...
   Begin VB.Image Image1 
      Height          =   390
      Left            =   0
      Picture         =   "CartM3&M2.frx":4FD9
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12285
   End
End
Attribute VB_Name = "Cartv2"
...
If xcode <> "" Then
           strSQL2 = "Select [Tenant Name] as TenantName, " & _
                ...
                "[Terms Year] as TermsYear, rentofmonth as rentofmonth1," & _
