...
Begin VB.Form LocationFrm 
   ...
   Begin VB.Image Image1 
      Height          =   570
      Left            =   0
      Picture         =   "LocationFrm.frx":4FB2
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9090
   End
End
Attribute VB_Name = "LocationFrm"
...
strSQL = "SELECT * from [Location] order by [Location Code]"
  Database_Refresh 0
...
Private Sub cmd_op_Click(Index As Integer)
       If choice = "Edit" Then
           strSQL3 = "SELECT [location Name] from [location] where [location Code] = '" & Trim(Text1(0).Text) & "'"
           Database_Refresh 2
           With adoPrimaryRS3
...
strSQL3 = "SELECT * from [location] where [location Code] = '" & Trim(Text1(0).Text) & "'"
   Database_Refresh 2
   With adoPrimaryRS3
        .Delete
        .Update
...
'If Index = 1 Then Text1(1).Text = UCase(Text1(1).Text)
End Sub
