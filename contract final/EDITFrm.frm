...
Begin VB.Form Shopwconfrm 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "For monthly Contract 1st month"
   ClientHeight    =   8820
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   9600
   ...
   Begin VB.Image Image1 
      Height          =   525
      Left            =   0
      Picture         =   "EDITFrm.frx":5033
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12285
   End
End
Attribute VB_Name = "Shopwconfrm"
...
If xcode <> "" Then
           strSQL2 = "Select [Tenant Name] as TenantName, " & _
                ...
                "[leased premises amt] as leasedpremisesamt,[Second month] as Secondmonth, " & _
                "[Leased Premises] as LeasedPremises,[SecCompute] as SecCompute1, [AdvCompute] as AdvCompute1, [SecCompute2word] as SecCompute2word1, [AdvCompute2word] as AdvCompute2word1, " & _
                "[Amount of rent] as Amountofrent,[Amount of rent2] as Amountofrent2, " & _
                "[Cusa Charges] as CusaCharges, [First month] as Firstmonth, " & _
                ...
                "[advancerent] as advancerent1 , rentofmonth as rentofmonth1," & _
                ...
                "[TENANTid] as TENANTidt,[Unit code] as unitcode," & _
                "[Terms Year] as TermsYear, [Pest Control] as PestControl," & _
                "[Company Code] as mk, [Terms to word] as termstoword," & _
                "[second Name] as secondName, [Typeofbis] as mk1," & _
                "[Tenant TIN] as TenantTIN,[Amoun to frent3] as Amountofrent3,[3 month] as 3month from [CONTRACT LEASE] where [TENANTid] = '" & xcode & "'"
                mbEditFlag = True
                Database_Refresh 1
...
Private Sub Form_Load()
   ...
   ' Rights5_Save = 1
    ...
    strSQL6 = "SELECT [Contract Name]  FROM typeOfContract WHERE [TypeS] like '" & "S" & "'"
    Database_Refresh 5
...
Private Sub Reload_PrimaryRS()
    ...
    '            "[settotalamtrenttext] as settotalamtrenttext1," & _
    '            "[Presentative Position] as PresentativePosition , " & _
    '            "[TENANTid] as TENANTidt,[Pest Control] as PestControl," & _
    '            "[Terms Year] as TermsYear,[Terms to word] as termstoword," & _
    '            "[Company Code] as mk, [Typeofbis] as mk1," & _
    '            "[second Name] as secondName, [Tenant TIN] as TenantTIN from [CONTRACT LEASE] where [typeofbis] like '" & "04" & "'"
    strSQL2 = "Select [Tenant Name] as TenantName, " & _
                "[Tenant Presentative] as TenantPresentative, " & _
                "[Presentative Address] as PresentativeAddress, " & _
                "[Presentative resnumber] as Presentativeresnumber, " & _
                ...
                "[Company Code] as mk, [Terms to word] as termstoword," & _
                "[second Name] as secondName, [Typeofbis] as mk1," & _
                "[Tenant TIN] as TenantTIN,[Amoun to frent3] as Amountofrent3,[3 month] as 3month from [CONTRACT LEASE]"
...
Label1(16).Caption = Val(Text1(13).Text * Text1(7).Text) * secdep
Label1(17).Caption = Val(Val(Text1(13).Text * Text1(7).Text) * adrent)
Text5.Text = secdep
                          Text6.Text = adrent
                          pili = "ITO"
...
Label1(16).Caption = Val(Val((Text1(13).Text * Text1(17).Text)) * Val(secdep))
Label1(17).Caption = Val(Val((Text1(13).Text * Text1(17).Text)) * Val(adrent))
Text9.Text = Val(Text1(13).Text * Text1(17).Text)
Text5.Text = secdep
                          Text6.Text = adrent
                          pili = "ITO"
                          Text7.Text = Amt2Words(Text5.Text)
...
Label1(16).Caption = Val(Val((Text1(13).Text * Text1(22).Text)) * Val(secdep))
Label1(17).Caption = Val(Val((Text1(13).Text * Text1(22).Text)) * Val(adrent))
Text9.Text = Val(Text1(13).Text * Text1(22).Text)
Text5.Text = secdep
                          Text6.Text = adrent
                          pili = "ITO"
                          Text7.Text = Amt2Words(Text5.Text)
...
If KeyAscii = 13 Then
    ...
    If Index = 17 Then Text1(23).SetFocus
    If Index = 23 Then Text1(22).SetFocus
    If Index = 22 Then Text1(20).SetFocus
    If Index = 20 Then Text1(8).SetFocus
    ...
    If Index = 21 Then Text1(0).SetFocus
End If
End Sub
Public Sub find_existingtenants()
xcode = Text1(14).Text
If xcode <> "" Then
          strSQL7 = "Select [Tenant Name] as TenantName, " & _
                "[Tenant Presentative] as TenantPresentative, " & _
                "[Presentative Address] as PresentativeAddress, " & _
                "[Presentative resnumber] as Presentativeresnumber, " & _
                "[Presentative Place issued] as PresentativePlaceissued," & _
                ...
                "[Leased Premises] as LeasedPremises,[Second month] as Secondmonth, " & _
                "[Amount of rent] as Amountofrent,[First month] as Firstmonth, " & _
                "[Amount of rent2] as Amountofrent2,[SecCompute] as SecCompute1, [AdvCompute] as AdvCompute1, [SecCompute2word] as SecCompute2word1, [AdvCompute2word] as AdvCompute2word1,  " & _
                "[Cusa Charges] as CusaCharges,[Pest Control] as PestControl, " & _
                "[usage of Premises] as usageofPremises, " & _
                "[Rental Commen Date] as RentalCommenDate, " & _
                "[Lease Expiry Date] as LeaseExpiryDate, " & _
                "[Presentative date issued] as Presentativedateissued, " & _
                "[Aircon Charges] as AirconCharges, rentofmonth as rentofmonth1, " & _
                "[Sectotalamt] as Sectotalamt1, " & _
                "[advancerent] as advancerent1 , " & _
                "[settotalamttotext] as settotalamttotext1," & _
                "[Settotalrenttotext] as Settotalrenttotext1," & _
                ...
                "[Terms Year] as TermsYear,[Terms to word] as termstoword," & _
                "[Company Code] as mk, [Typeofbis] as mk1," & _
                "[second Name] as secondName, [Tenant TIN] as TenantTIN,[Amoun to frent3] as Amountofrent3,[3 month] as 3month from [CONTRACT LEASE] where [TENANTid] = '" & xcode & "'"
                mbEditFlag = True
                Database_Refresh 6
...
strSQL7 = "Select * from [Contract Lease OLD]"
                ...
                adoPrimaryRS7.Fields(50) = adoPrimaryRS10.Fields(49)
                adoPrimaryRS7.Fields(51) = adoPrimaryRS10.Fields(50)
...
strSQL2 = "Select [Tenant Name] as TenantName, " & _
                ...
                "[Terms Year] as TermsYear,[Terms to word] as termstoword," & _
                "[Company Code] as mk, [Typeofbis] as mk1," & _
                "[second Name] as secondName, [Tenant TIN] as TenantTIN,[Amoun to frent3] as Amountofrent3,[3 month] as 3month from [CONTRACT LEASE] where [TENANTid] = '" & Text1(14) & "'"
                mbEditFlag = True
                Database_Refresh 1
                If adoPrimaryRS2.RecordCount = 0 Then
                    MsgBox "No record!, ", vbOKOnly + vbCritical, "Warning:End-User:" + UserName
