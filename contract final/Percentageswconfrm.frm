...
Begin VB.Form Percentageswconfrm 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Percentages w/ con"
   ClientHeight    =   8235
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   9615
   Icon            =   "Percentageswconfrm.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8235
   ...
   Begin LVbuttons.LaVolpeButton cmdedit 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "Percentageswconfrm.frx":4F0A
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      BorderStyle     =   0
      BackColor       =   16777215
      PaneTree        =   "Percentageswconfrm.frx":4F26
   ...
   Begin LVbuttons.LaVolpeButton cmdcancel 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "Percentageswconfrm.frx":4FB8
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   Begin LVbuttons.LaVolpeButton cmd_op 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "Percentageswconfrm.frx":4FD4
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   Begin LVbuttons.LaVolpeButton cmdDone 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "Percentageswconfrm.frx":4FF0
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   Begin MSComCtl2.DTPicker dtStart 
      Bindings        =   "Percentageswconfrm.frx":500C
      Height          =   375
      Index           =   1
      Left            =   12915
      TabIndex        =   59
   ...
   Begin LVbuttons.LaVolpeButton cmd 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "Percentageswconfrm.frx":5017
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   Begin VB.Image Image1 
      Height          =   525
      Left            =   0
      Picture         =   "Percentageswconfrm.frx":5033
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12285
   End
End
Attribute VB_Name = "Percentageswconfrm"
...
If xcode <> "" Then
           strSQL2 = "Select [Tenant Name] as TenantName, " & _
                ...
                "[second Name] as secondName, [Tenant TIN] as TenantTIN from [CONTRACT LEASE] where [typeofbis] like '" & "06" & "'"
                mbEditFlag = True
                Database_Refresh 1
...
Private Sub Form_Load()
   ...
   ' Rights5_Save = 1
    ...
    strSQL6 = "SELECT [Contract Name]  FROM typeOfContract WHERE [TypeS] like '" & "P" & "'"
...
Private Sub Reload_PrimaryRS()
    ...
    strSQL2 = "Select [Tenant Name] as TenantName, " & _
                ...
                "[Terms Year] as TermsYear," & _
                "[Company Code] as mk, [Typeofbis] as mk1," & _
                "[second Name] as secondName, [Tenant TIN] as TenantTIN from [CONTRACT LEASE]"
                Database_Refresh 1
...
If KeyAscii = 13 Then
    ...
    If Index = 20 Then Text1(0).SetFocus
End If
End Sub
