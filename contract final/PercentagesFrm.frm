...
Begin VB.Form Percentagesfrm 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      BorderStyle     =   0
      BackColor       =   16777215
      PaneTree        =   "PercentagesFrm.frx":4F26
   ...
   Begin MSComCtl2.DTPicker dtStart 
      Bindings        =   "PercentagesFrm.frx":500C
      Height          =   375
      Index           =   1
      Left            =   12915
      TabIndex        =   57
   ...
   Begin VB.Image Image1 
      Height          =   435
      Left            =   0
      Picture         =   "PercentagesFrm.frx":5033
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12285
   End
   ...
   End
End
Attribute VB_Name = "Percentagesfrm"
...
Private Sub Reload_PrimaryRS()
    ...
    strSQL2 = "Select [Tenant Name] as TenantName, " & _
                ...
                "[Presentative resnumber] as Presentativeresnumber, " & _
                "[Presentative Place issued] as PresentativePlaceissued," & _
                "[leased premises amt] as leasedpremisesamt,[First month] as Firstmonth,  " & _
                "[Leased Premises] as LeasedPremises,[SecCompute] as SecCompute1, [AdvCompute] as AdvCompute1,[SecCompute2word] as SecCompute2word1, [AdvCompute2word] as AdvCompute2word1, " & _
...
If Index = 16 Or Index = 7 Or Index = 8 Or Index = 12 Or Index = 13 Then
        Select Case KeyAscii
                ...
                Case 13
                         ...
                         'If Index = 16 Then Text1(7).SetFocus
...
If KeyAscii = 13 Then
    ...
    If Index = 19 Then Text1(0).SetFocus
    
    If Index = 7 Then
        Text1(18).SetFocus
        Dim sn As String
        Dim sn1 As String
        sn = Val(Val(Text1(13).Text * Text1(7).Text) * secdep)
        sn1 = Val(Val(Text1(13).Text * Text1(7).Text) * adrent)
        'Text9.Text = Val(Text1(13).Text * Text1(18).Text)
        Text5.Text = secdep
                          Text6.Text = adrent
                          pili = "ITO"
    ...
    If Index = 16 Then
       ...
       Text1(7).SetFocus
    End If
    If Index = 18 Then Text1(8).SetFocus
